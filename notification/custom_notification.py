...
def process_notification():
    try:
        notifications = frappe.get_all(
            ...
            fields=["name", "custom_select_time", "event"]
        )
        ...
        for notification in notifications:
            ...
            if doc.event == "Days After" or doc.event == "Days Before":
                ...
                frappe.log_error("Only days after and days before events are supported", "Event Error")
    except Exception as e:
